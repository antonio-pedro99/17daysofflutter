...
class achieved extends Component with HasGameRef<DoodleDash> {
  achieved({this.selectedLevel = 1, this.level = 1});
  ...
  // gravity is constant, jumpSpeed needs to accommodate for further distance.
  // Score indicates the score needed to be achieved to "level up"
